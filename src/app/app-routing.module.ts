...
const routes: Routes = [
  ...
  {path: 'intro', component: AlumnosComponent},
  {path: 'intro', component: InicioVigilantesComponent},
  {path: 'intro', component: MenuComponent},
  {path: 'intro', component: MenuAlumnoComponent},
  {path: 'intro', component: MenuVigilantes2Component},
  {path: 'intro', component: MenuVigilantesComponent},
  {path: 'intro', component: RegistroEx1Component},
  {path: 'intro', component: RegistroEx2Component},
  {path: 'intro', component: RegistroVigComponent},
  {path: 'intro', component: RegistroTemporalComponent},
  {path: 'intro', component: RegistroTemporal2Component},
